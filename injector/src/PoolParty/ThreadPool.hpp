...
typedef VOID(NTAPI* PTP_ALPC_CALLBACK)(PTP_CALLBACK_INSTANCE, PVOID, PFULL_TP_ALPC);

EXTERN_C NTSTATUS NTAPI TpAllocAlpcCompletion(PFULL_TP_ALPC*, HANDLE, PTP_ALPC_CALLBACK, PVOID, PTP_CALLBACK_ENVIRON);
EXTERN_C NTSTATUS NTAPI TpAllocJobNotification(PFULL_TP_JOB*, HANDLE, PVOID, PVOID, PTP_CALLBACK_ENVIRON);

PFULL_TP_WORK w_CreateThreadpoolWork(PTP_WORK_CALLBACK, PVOID, PTP_CALLBACK_ENVIRON);
PFULL_TP_WAIT w_CreateThreadpoolWait(PTP_WAIT_CALLBACK, PVOID, PTP_CALLBACK_ENVIRON);
PFULL_TP_IO w_CreateThreadpoolIo(HANDLE, PTP_WIN32_IO_CALLBACK, PVOID, PTP_CALLBACK_ENVIRON);
PFULL_TP_ALPC w_TpAllocAlpcCompletion(HANDLE, PTP_ALPC_CALLBACK, PVOID, PTP_CALLBACK_ENVIRON);
PFULL_TP_JOB w_TpAllocJobNotification(HANDLE, PVOID, PVOID, PTP_CALLBACK_ENVIRON);
PFULL_TP_TIMER w_CreateThreadpoolTimer(PTP_TIMER_CALLBACK, PVOID, PTP_CALLBACK_ENVIRON);